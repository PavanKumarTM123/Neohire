...
// }
import { useState, useEffect } from "react";
import Pagination from "react-responsive-pagination"; // Ensure this is installed via npm or yarn
import "react-responsive-pagination/styles.css"; // Import styles for pagination
  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await fetch(
        `https://localhost:7278/api/admin/users?page=${currentPage}&limit=${usersPerPage}`
      );
    ...
    <div className="min-h-screen bg-blue-50 flex flex-col items-center p-6">
      ...
      <div className="w-full max-w-6xl bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="mt-4">
          <Pagination
            current={currentPage}
            total={100} // Replace with the total number of users
